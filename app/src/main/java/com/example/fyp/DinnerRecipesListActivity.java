...
public class DinnerRecipesListActivity extends AppCompatActivity implements RecipeAdapter.OnRecipeClickListener {
    ...
    public DinnerRecipesListActivity() {
            ...
            spoonacularService.getRecipeDetails(Integer.parseInt(id), new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        weekViewActivity.addDinnerToList(title, calories, imageUrl);

                        Intent intent = new Intent(DinnerRecipesListActivity.this, WeekViewActivity.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(DinnerRecipesListActivity.this, "Error fetching recipe details: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dinner_recipes_list);
        ...
        textViewCaloriesRange.setText("Dinners between " + minCalories + " and " + maxCalories);

        // Find the RecyclerView and set its layout manager
        recyclerView = findViewById(R.id.dinner_recipes_recycler_view);
        ...
        RecipeAdapter recipeAdapter = new RecipeAdapter(recipesArray, DinnerRecipesListActivity.this, DinnerRecipesListActivity.this);
